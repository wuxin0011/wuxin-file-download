...
<div class="container col-xl-6 col-sm-12 col-xs-12 col-xxl-4 px-10 py-10 mt-5">
    ...
    <div class="mb-2 mt-2">
        <span>您可以通过邮箱联系我</span><a href="mailto:2191377759@qq.com">2191377759@qq.com</a>
        <span>或者通过留言板</span>
    </div>
    ...
    <div id="messageForm">
        ...
        <div class="mb-3">
            <a class="btn btn-outline-primary btn-sm" href="javascript:history.go(-1)" style="text-decoration: none;">返回</a>
            <button class="btn btn-primary btn-sm " type="submit" id="submitBtn" style="text-decoration: none;">提交
            </button>
        </div>
    </div>
